  ...
  return (
    <div style={{ maxWidth: '60rem', margin: '5rem auto', padding: '3.2rem' }}>
      ...
      <p>
        ...
        luctus non, massa.{' '}
        <i>Lorem ipsum dolor sit amet, consectetur adipiscing elit</i>. Fusce ac
      ...
      <p>
        ...
        dui. Praesent blandit dolor. <b>Etiam ultrices</b>. Sed non quam. In vel
        mi sit amet augue congue elementum. Morbi in ipsum sit amet pede
        facilisis laoreet. <b>Suspendisse in justo eu magna luctus suscipit</b>.
        Donec lacus nunc, viverra nec, blandit vel, egestas et, augue.{' '}
        <i>Mauris ipsum</i>. Vestibulum tincidunt malesuada tellus. Ut ultrices
